...
<div class="animate-reveal pb-20">
    ...
    <div class="glass-card rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-white overflow-hidden">
            ...
            <div class="sidebar-gradient px-4 md:px-8 py-4 md:py-6">
                <h2 class="text-white text-lg md:text-2xl font-bold tracking-tight">Beri Nilai untuk SS</h2>
                <p class="text-blue-200 text-[10px] md:text-xs mt-1">Berikan penilaian score dan catatan untuk ide SS ini</p>
            </div>
            ...
            <div class="p-4 md:p-8">
                <form action="{{ route('ss.admin.assess.store', $submission->id) }}" method="POST">
                    ...
                    <!-- Score Field -->
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Score <span class="text-red-500">*</span></label>
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 flex items-center gap-1"><i class="fa-solid fa-circle-info"></i> Range nilai 0 - 100</p>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="notes" rows="4" class="w-full border border-gray-200 rounded-xl p-3 focus:ring-2 focus:ring-[#091E6E] focus:border-transparent bg-gray-50/30 text-sm" placeholder="Tulis catatan atau alasan penilaian..."></textarea>

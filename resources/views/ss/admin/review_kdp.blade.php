...
<div class="animate-reveal pb-20">
    ...
    <nav class="flex mb-4 md:mb-6 text-xs md:text-sm text-gray-400">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="text-[#091E6E] font-semibold tracking-tight text-[10px] md:text-xs">Review KDP</li>
        </ol>
    </nav>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="glass-card rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-white overflow-hidden">
            ...
            <div class="sidebar-gradient px-4 md:px-8 py-4 md:py-6">
                ...
                <p class="text-blue-200 text-[10px] md:text-xs mt-1">Berikan persetujuan final untuk ide SS ini</p>
            </div>
            ...
            <div class="p-4 md:p-8">
                <form action="{{ route('ss.admin.review_kdp.store', $submission->id) }}" method="POST">
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="kdp_notes" rows="4" class="w-full border border-gray-200 rounded-xl p-3 focus:ring-2 focus:ring-[#091E6E] focus:border-transparent bg-gray-50/30 text-sm" placeholder="Tulis alasan persetujuan atau penolakan..."></textarea>

...
<div class="animate-reveal pb-20 max-w-2xl mx-auto">
    ...
    <div class="glass-card rounded-2xl p-6">
        <h2 class="text-xl font-bold text-[#091E6E] mb-4">Review SPV</h2>
        <form action="{{ route('ss.admin.review_spv.store', $submission->id) }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-sm font-bold mb-2">Catatan SPV</label>
                <textarea name="spv_notes" rows="3" class="w-full border rounded-xl p-3"></textarea>
            </div>
            <button type="submit" class="bg-purple-600 text-white px-5 py-2 rounded-xl">Kirim Review</button>
        </form>
    </div>
</div>
@endsection
...
@section('title', 'Dashboard Progres Saya')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const labels = [
            ['Step 0', stepMonths[0]], ['Step 1', stepMonths[1]], ['Step 2', stepMonths[2]],
            ['Step 3', stepMonths[3]], ['Step 4', stepMonths[4]], ['Step 5', stepMonths[5]],
            ['Step 6', stepMonths[6]], ['Step 7', stepMonths[7]], ['Step 8', stepMonths[8]]
        ];

        Chart.register(ChartDataLabels);

        // Plugin Garis Merah (Discrete Logic - Tepat di Ujung Bar Approved)
        const verticalLinePlugin = {
            ...
            afterDraw: (chart) => {
                if (chart.config.type === 'bar') {
                    ...
                    const meta = chart.getDatasetMeta(2); // Dataset Approved

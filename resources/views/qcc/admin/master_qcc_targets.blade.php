...
<div class="animate-reveal">
    ...
    <nav class="flex mb-4 md:mb-6 text-xs md:text-sm text-gray-400">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="text-[#091E6E] font-semibold tracking-tight text-[10px] md:text-xs">Master Target</li>
        </ol>
    </nav>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 md:mb-8 gap-4">
        <div>
            <h2 class="text-2xl md:text-3xl font-bold text-[#091E6E]">Master Target QCC</h2>
            <p class="text-xs md:text-sm text-gray-400">Tentukan target jumlah circle per periode & departemen</p>
        </div>
        
        <div class="flex flex-wrap gap-3 w-full md:w-auto justify-start md:justify-end items-center">
            <form action="{{ route('qcc.admin.master_targets') }}" method="GET" id="filterForm" class="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full md:w-auto">
                ...
                <div class="relative w-full sm:w-64">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari Dept atau Periode..." 
            ...
            <table class="w-full text-left border-separate border-spacing-y-2 min-w-[800px] md:min-w-full">
                <thead>
                    <tr class="sidebar-gradient shadow-md text-white text-[8px] md:text-[10px] uppercase tracking-widest font-bold">
                        ...
                        <th class="px-3 md:px-6 py-3 md:py-4 text-center">Target (Circle)</th>
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center py-10 md:py-20 text-gray-300 italic text-xs md:text-sm">Belum ada target yang ditetapkan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="flex items-center justify-center min-h-screen p-2 md:p-4 text-left">
        <div class="bg-white rounded-[1.5rem] md:rounded-[2rem] w-full max-w-lg shadow-2xl animate-reveal overflow-hidden">  
            <div class="sidebar-gradient p-4 md:p-6 text-white flex justify-between items-center">
                <h3 class="text-base md:text-xl font-bold"><i class="fa-solid fa-bullseye mr-2"></i>
